...
use sms\controller\ErrorController;
...
class Router {
    ...
    public function __construct(DependencyInjector $di) {
        ...
        $json = file_get_contents(__DIR__ . '/../../config/route.json');
...
//        echo 'Path: '.$path.'<br>';
    ...
    string $route, string $path, array $info, Request $request
    ): string {
        $controllerName = '\sms\controller\\' . $info['controller'] . 'Controller';
