...
CREATE ROLE ao;
ALTER ROLE ao WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5269fcbb554777d20ac535a5be0f6c9f7';
...
CREATE ROLE hr;
ALTER ROLE hr WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md57a65391ae46405307664b39c8e19ae5f';
CREATE ROLE mgt;
ALTER ROLE mgt WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md5a92b005971876f9d0011219c9726c63a';
CREATE ROLE npdcbi;
...
--
-- Name: mgt; Type: SCHEMA; Schema: -; Owner: sms_admin
--

CREATE SCHEMA mgt;


ALTER SCHEMA mgt OWNER TO sms_admin;
...
--
-- Name: teacher; Type: SCHEMA; Schema: -; Owner: sms_admin
--

CREATE SCHEMA teacher;


ALTER SCHEMA teacher OWNER TO sms_admin;
...
CREATE TABLE login (
    ...
    vemployee character varying(100)
);
...
SET search_path = mgt, pg_catalog;

--
-- Name: login; Type: TABLE; Schema: mgt; Owner: sms_admin
--
...
--
-- Name: attreg_attregdetail; Type: TABLE; Schema: teaching; Owner: sms_admin
--
...
ALTER TABLE attreg_attregdetail OWNER TO sms_admin;
...
CREATE TABLE class (
    ...
    bsid smallint,
    vattreg character varying(100),
    ssdaypattern smallint
);
...
--
-- Name: daypattern; Type: TABLE; Schema: teaching; Owner: sms_admin
--

CREATE TABLE daypattern (
    ssdaypattern smallint NOT NULL,
    vshortdesc character varying(50) NOT NULL,
    vdesc character varying(100) NOT NULL
);


ALTER TABLE daypattern OWNER TO sms_admin;

--
-- Name: daypattern_ssdaypattern_seq; Type: SEQUENCE; Schema: teaching; Owner: sms_admin
--

CREATE SEQUENCE daypattern_ssdaypattern_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE daypattern_ssdaypattern_seq OWNER TO sms_admin;

--
-- Name: daypattern_ssdaypattern_seq; Type: SEQUENCE OWNED BY; Schema: teaching; Owner: sms_admin
--

ALTER SEQUENCE daypattern_ssdaypattern_seq OWNED BY daypattern.ssdaypattern;
...
--
-- Name: daypattern ssdaypattern; Type: DEFAULT; Schema: teaching; Owner: sms_admin
--

ALTER TABLE ONLY daypattern ALTER COLUMN ssdaypattern SET DEFAULT nextval('daypattern_ssdaypattern_seq'::regclass);
...
COPY login (vusername, vpassword, vemployee) FROM stdin;
hr@test.com	$2y$10$R7D1vy1F.ah5XxuDjvYqzeHi6oVdzZnT5HxiDgEEHkmSo3qJJiB2e	\N
\.
...
--
-- Data for Name: login; Type: TABLE DATA; Schema: mgt; Owner: sms_admin
--

COPY login (vusername, vpassword) FROM stdin;
admin@test.com	$2y$10$FU17jzQuJcmQt4m0LRvMcuUXjIemm7mLaWzSbTAou6zr.ATl7SQ42
\.
...
COPY attreg (vattreg, dstartdate, denddate) FROM stdin;
ATT20184CB1C	2010-01-01	2010-03-01
ATT2018C9E97	2010-01-01	2010-03-01
ATT20183C41D	2010-01-01	2010-03-01
ATT2018D2ED5	2010-01-01	2010-04-01
\.


--
-- Data for Name: attreg_attregdetail; Type: TABLE DATA; Schema: teaching; Owner: sms_admin
--
...
COPY attregdetail (ssattregdetail, contactdate, vfirstname, vlastname, battendance, vstudent) FROM stdin;
\.
...
COPY class (vclass, vclassteacher, vclassname, vclassroom, bsid, vattreg, ssdaypattern) FROM stdin;
P1A	E2018D0E09	PRIMARY ONE A	P1A	2	\N	\N
P1B	E201803F81	PRIMARY ONE B	P1B	3	\N	\N
P2A	E201803F81	PRIMARY 2 A	P2A	3	ATT20184CB1C	2
P2B	E2018D0E09	PRIMARY 2 B	P2B	2	ATT2018C9E97	2
P2C	E201803F81	PRIMARY 2 C	P2C	2	ATT20183C41D	3
P2D	E201803F81	PRIMARY 2 D	P2D	2	ATT2018D2ED5	2
\.
...
P2A	PRIMARY 2 CLASSROOM A
P2B	PRIMARY 2 CLASSROOM B
P2C	PRIMARY 2 CLASSROOM C
P2D	PRIMARY 2 CLASSROOM D
\.


--
-- Data for Name: daypattern; Type: TABLE DATA; Schema: teaching; Owner: sms_admin
--

COPY daypattern (ssdaypattern, vshortdesc, vdesc) FROM stdin;
2	M/T/W/T/F	MONDAY/TUESDAY/WEDNESDAY/THURSDAY/FRIDAY
3	M/W/F	MONDAY/WEDNESDAY/FRIDAY
5	T/T	TUESDAY/THURSDAY
\.


--
-- Name: daypattern_ssdaypattern_seq; Type: SEQUENCE SET; Schema: teaching; Owner: sms_admin
--

SELECT pg_catalog.setval('daypattern_ssdaypattern_seq', 5, true);
...
--
-- Name: login pkmgtlogin; Type: CONSTRAINT; Schema: mgt; Owner: sms_admin
--

ALTER TABLE ONLY login
    ADD CONSTRAINT pkmgtlogin PRIMARY KEY (vusername);
...
--
-- Name: daypattern pkssdaypattern; Type: CONSTRAINT; Schema: teaching; Owner: sms_admin
--

ALTER TABLE ONLY daypattern
    ADD CONSTRAINT pkssdaypattern PRIMARY KEY (ssdaypattern);
...
--
-- Name: login fkemp; Type: FK CONSTRAINT; Schema: hr; Owner: sms_admin
--

ALTER TABLE ONLY login
    ADD CONSTRAINT fkemp FOREIGN KEY (vemployee) REFERENCES employee(vemployee);
...
--
-- Name: attregdetail fk_student; Type: FK CONSTRAINT; Schema: teaching; Owner: root
--

ALTER TABLE ONLY attregdetail
    ADD CONSTRAINT fk_student FOREIGN KEY (vstudent) REFERENCES student(vstudent);
...
--
-- Name: attreg_attregdetail fkattreg; Type: FK CONSTRAINT; Schema: teaching; Owner: sms_admin
--
...
--
-- Name: attreg_attregdetail fkattregdetail; Type: FK CONSTRAINT; Schema: teaching; Owner: sms_admin
--
...
--
-- Name: class fkssdaypattern; Type: FK CONSTRAINT; Schema: teaching; Owner: sms_admin
--

ALTER TABLE ONLY class
    ADD CONSTRAINT fkssdaypattern FOREIGN KEY (ssdaypattern) REFERENCES daypattern(ssdaypattern);


--
-- Name: class fkvattreg; Type: FK CONSTRAINT; Schema: teaching; Owner: sms_admin
--

ALTER TABLE ONLY class
    ADD CONSTRAINT fkvattreg FOREIGN KEY (vattreg) REFERENCES attreg(vattreg);
...
--
-- Name: mgt; Type: ACL; Schema: -; Owner: sms_admin
--

GRANT USAGE ON SCHEMA mgt TO mgt;
...
--
-- Name: login; Type: ACL; Schema: mgt; Owner: sms_admin
--

GRANT ALL ON TABLE login TO mgt;
...
--
-- Name: attreg; Type: ACL; Schema: teaching; Owner: root
--

GRANT SELECT,INSERT ON TABLE attreg TO mgt;
...
--
-- Name: daypattern; Type: ACL; Schema: teaching; Owner: sms_admin
--

GRANT SELECT ON TABLE daypattern TO mgt;
