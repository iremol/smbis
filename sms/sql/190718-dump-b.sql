...
--
-- Name: sms; Type: DATABASE; Schema: -; Owner: root
--

CREATE DATABASE sms WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';


ALTER DATABASE sms OWNER TO root;
